...
const attachGuest = function (event, embedderFrameId, elementInstanceId, guestInstanceId, params) {
  ...
  webViewManager.addGuest(embedderFrameId, guestInstanceId, elementInstanceId, embedder, guest, webPreferences)
  guest.willAttach(embedder, embedderFrameId);
}
